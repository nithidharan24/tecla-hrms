        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="page-header">
                    <h2 class="pageheader-title">Edit Termination Letter Template</h2>
        ...
        <div class="row mt-4">
            <div class="col-xl-12">
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('termination-letter-templates.update', $template->id) }}">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <textarea class="form-control @error('content') is-invalid @enderror" id="content" name="content" rows="15" required>{{ old('content', $template->content) }}</textarea>
