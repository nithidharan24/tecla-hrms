                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select name="category" class="form-control" required>
                                ...
                                <option value="Technical" {{ old('category', $question->category) == 'Technical' ? 'selected' : '' }}>Technical</option>
                                <option value="Behavioral" {{ old('category', $question->category) == 'Behavioral' ? 'selected' : '' }}>Behavioral</option>
                                <option value="Logical" {{ old('category', $question->category) == 'Logical' ? 'selected' : '' }}>Logical</option>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <textarea name="code_snippets" class="form-control" rows="3" placeholder="Optional: Add code snippets here...">{{ old('code_snippets', $question->code_snippets) }}</textarea>
                            @error('code_snippets')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <textarea name="answer_explanation" class="form-control" rows="3" placeholder="Optional: Explain the answer...">{{ old('answer_explanation', $question->answer_explanation) }}</textarea>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="url" name="video_link" class="form-control" value="{{ old('video_link', $question->video_link) }}" placeholder="Optional: YouTube or Vimeo link">
                            @error('video_link')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            @if($question->question_image)
                                <div class="mt-2">
                                    ...
                                    <img src="{{ asset($question->question_image) }}" alt="Question Image" class="img-thumbnail mt-1" style="max-width: 150px;">
                                </div>
                            @endif
                        </div>
                    </div>
