...
<html lang="en" data-layout="vertical" data-topbar="light" data-sidebar="dark" data-sidebar-size="lg" data-sidebar-image="none">
    ...
    $fontFamily = FontMasterController::getFontFamily();
    $googleFontLink = FontMasterController::getGoogleFontLink($fontFamily);
@endphp

<link href="{{ $googleFontLink }}" rel="stylesheet">

<style>
    /* ✅ Global Google Font Application */
    body, html, h1, h2, h3, h4, h5, h6, p, a, div, input, select, textarea, button, label, table, th, td {
