        ...
        <div class="row mt-4">
            <div class="col-xl-12">
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                        <form id="adminForm" method="POST" action="{{ route('adminaccess.update', $admin->id) }}" class="needs-validation" novalidate>
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <!-- Name -->
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="name" id="name" placeholder="Enter Full Name" value="{{ old('name', $admin->name) }}" required>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="email" class="form-control" name="email" id="email" placeholder="Enter Email" value="{{ old('email', $admin->email) }}" required>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="invalid-feedback">Password must be at least 6 characters long if provided.</div>
                                    @error('password')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                                            ...
                                                            <div class="module-item">
                                                                <div class="form-check">
                                                                    <input class="form-check-input module-checkbox" 
                                                                           ...
                                                                           name="modules[]" 
                                                                           value="Recruitment"
                                                                           {{ in_array('Recruitment', $adminModules ?? []) ? 'checked' : '' }}>
                                                            ...
                                                            <div class="module-item mb-3">
                                                                <div class="form-check">
                                                                    <input class="form-check-input module-checkbox" 
                                                                           ...
                                                                           name="modules[]" 
                                                                           value="Team Leaves"
                                                                           {{ in_array('Team Leaves', $adminModules ?? []) ? 'checked' : '' }}>
                                                            ...
                                                            <div class="module-item mb-3">
                                                                <div class="form-check">
                                                                    <input class="form-check-input module-checkbox" 
                                                                           ...
                                                                           {{ in_array('Employee Leaves', $adminModules ?? []) ? 'checked' : '' }}>
                                                            ...
                                                            <div class="module-item mb-3">
                                                                <div class="form-check">
                                                                    <input class="form-check-input module-checkbox" 
                                                                           ...
                                                                           {{ in_array('Admin Attendance', $adminModules ?? []) ? 'checked' : '' }}>
                                                            ...
                                                            <div class="module-item mb-3">
                                                                <div class="form-check">
                                                                    <input class="form-check-input module-checkbox" 
                                                                           ...
                                                                           {{ in_array('Employee Attendance', $adminModules ?? []) ? 'checked' : '' }}>
                                                            ...
                                                            <div class="module-item mb-3">
                                                                <div class="form-check">
                                                                    <input class="form-check-input module-checkbox" 
                                                                           ...
                                                                           {{ in_array('Late Punch Approval', $adminModules ?? []) ? 'checked' : '' }}>
                                                            ...
                                                            <div class="module-item mb-3">
                                                                <div class="form-check">
                                                                    <input class="form-check-input module-checkbox"
                                                                           ...
                                                                           name="modules[]"
                                                                           value="Clients"
                                                                           {{ in_array('Clients', $adminModules ?? []) ? 'checked' : '' }}>
                                                            ...
                                                            <div class="module-item mb-3">
                                                                <div class="form-check">
                                                                    <input class="form-check-input module-checkbox"
                                                                           ...
                                                                           name="modules[]"
                                                                           value="Projects"
                                                                           {{ in_array('Projects', $adminModules ?? []) ? 'checked' : '' }}>
                                                            ...
                                                            <div class="module-item mb-3">
                                                                <div class="form-check">
                                                                    <input class="form-check-input module-checkbox"
                                                                           ...
                                                                           name="modules[]"
                                                                           value="Project Tasks"
                                                                           {{ in_array('Project Tasks', $adminModules ?? []) ? 'checked' : '' }}>
                                                            ...
                                                            <div class="module-item mb-3">
                                                                <div class="form-check">
                                                                    <input class="form-check-input module-checkbox"
                                                                           ...
                                                                           name="modules[]"
                                                                           value="My Tasks"
                                                                           {{ in_array('My Tasks', $adminModules ?? []) ? 'checked' : '' }}>
                                                            ...
                                                            <div class="module-item">
                                                                <div class="form-check">
                                                                    <input class="form-check-input module-checkbox" 
                                                                           ...
                                                                           name="modules[]" 
                                                                           value="Employee"
                                                                           {{ in_array('Employee', $adminModules ?? []) ? 'checked' : '' }}>
                                                        ...
                                                        <div class="category-body p-3">
                                                            <div class="form-check">
                                                                <input class="form-check-input module-checkbox"
                                                                       ...
                                                                       name="modules[]"
                                                                       value="Shifts"
                                                                       {{ in_array('Shifts', $adminModules ?? []) ? 'checked' : '' }}>
                                                        ...
                                                        <div class="category-body p-3">
                                                            <div class="form-check">
                                                                <input class="form-check-input module-checkbox"
                                                                       ...
                                                                       name="modules[]"
                                                                       value="Schedule"
                                                                       {{ in_array('Schedule', $adminModules ?? []) ? 'checked' : '' }}>
                                                            ...
                                                            <div class="module-item mb-3">
                                                                <div class="form-check">
                                                                    <input class="form-check-input module-checkbox"
                                                                           ...
                                                                           name="modules[]"
                                                                           value="Payroll Items"
                                                                           {{ in_array('Payroll Items', $adminModules ?? []) ? 'checked' : '' }}>
                                                            ...
                                                            <div class="module-item mb-3">
                                                                <div class="form-check">
                                                                    <input class="form-check-input module-checkbox"
                                                                           ...
                                                                           {{ in_array('Employee Salary', $adminModules ?? []) ? 'checked' : '' }}>
                                                            ...
                                                            <div class="module-item mb-3">
                                                                <div class="form-check">
                                                                    <input class="form-check-input module-checkbox"
                                                                           ...
                                                                           {{ in_array('Automated Payslips', $adminModules ?? []) ? 'checked' : '' }}>
                                                            ...
                                                            <div class="module-item mb-3">
                                                                <div class="form-check">
                                                                    <input class="form-check-input module-checkbox"
                                                                           ...
                                                                           name="modules[]"
                                                                           value="Activity Log"
                                                                           {{ in_array('Activity Log', $adminModules ?? []) ? 'checked' : '' }}>
                                                            ...
                                                            <div class="module-item mb-3">
                                                                <div class="form-check">
                                                                    <input class="form-check-input module-checkbox"
                                                                           ...
                                                                           name="modules[]"
                                                                           value="Tickets"
                                                                           {{ in_array('Tickets', $adminModules ?? []) ? 'checked' : '' }}>
                                                            ...
                                                            <div class="module-item mb-3">
                                                                <div class="form-check">
                                                                    <input class="form-check-input module-checkbox"
                                                                           ...
                                                                           name="modules[]"
                                                                           value="Testing"
                                                                           {{ in_array('Testing', $adminModules ?? []) ? 'checked' : '' }}>
                                                            ...
                                                            <div class="module-item mb-3">
                                                                <div class="form-check">
                                                                    <input class="form-check-input module-checkbox"
                                                                           ...
                                                                           name="modules[]"
                                                                           value="Estimates"
                                                                           {{ in_array('Estimates', $adminModules ?? []) ? 'checked' : '' }}>
                                                            ...
                                                            <div class="module-item mb-3">
                                                                <div class="form-check">
                                                                    <input class="form-check-input module-checkbox"
                                                                           ...
                                                                           name="modules[]"
                                                                           value="Invoices"
                                                                           {{ in_array('Invoices', $adminModules ?? []) ? 'checked' : '' }}>
                                                            ...
                                                            <div class="module-item mb-3">
                                                                <div class="form-check">
                                                                    <input class="form-check-input module-checkbox"
                                                                           ...
                                                                           name="modules[]"
                                                                           value="Payments"
                                                                           {{ in_array('Payments', $adminModules ?? []) ? 'checked' : '' }}>
                                                            ...
                                                            <div class="module-item mb-3">
                                                                <div class="form-check">
                                                                    <input class="form-check-input module-checkbox"
                                                                           ...
                                                                           name="modules[]"
                                                                           value="Expenses"
                                                                           {{ in_array('Expenses', $adminModules ?? []) ? 'checked' : '' }}>
                                                            ...
                                                            <div class="module-item mb-3">
                                                                <div class="form-check">
                                                                    <input class="form-check-input module-checkbox"
                                                                           ...
                                                                           name="modules[]"
                                                                           value="Taxes"
                                                                           {{ in_array('Taxes', $adminModules ?? []) ? 'checked' : '' }}>
                                                            ...
                                                            <div class="module-item mb-3">
                                                                <div class="form-check">
                                                                    <input class="form-check-input module-checkbox"
                                                                           ...
                                                                           name="modules[]"
                                                                           value="Categories"
                                                                           {{ in_array('Categories', $adminModules ?? []) ? 'checked' : '' }}>
                                                            ...
                                                            <div class="module-item mb-3">
                                                                <div class="form-check">
                                                                    <input class="form-check-input module-checkbox"
                                                                           ...
                                                                           name="modules[]"
                                                                           value="Budgets"
                                                                           {{ in_array('Budgets', $adminModules ?? []) ? 'checked' : '' }}>
                                                            ...
                                                            <div class="module-item mb-3">
                                                                <div class="form-check">
                                                                    <input class="form-check-input module-checkbox"
                                                                           ...
                                                                           {{ in_array('Budget Expenses', $adminModules ?? []) ? 'checked' : '' }}>
                                                            ...
                                                            <div class="module-item mb-3">
                                                                <div class="form-check">
                                                                    <input class="form-check-input module-checkbox"
                                                                           ...
                                                                           {{ in_array('Budget Revenues', $adminModules ?? []) ? 'checked' : '' }}>
                                                            ...
                                                            <div class="module-item mb-3">
                                                                <div class="form-check">
                                                                    <input class="form-check-input module-checkbox"
                                                                           ...
                                                                           name="modules[]"
                                                                           value="My Reports"
                                                                           {{ in_array('My Reports', $adminModules ?? []) ? 'checked' : '' }}>
                                                            ...
                                                            <div class="module-item mb-3">
                                                                <div class="form-check">
                                                                    <input class="form-check-input module-checkbox"
                                                                           ...
                                                                           name="modules[]"
                                                                           value="Team Reports"
                                                                           {{ in_array('Team Reports', $adminModules ?? []) ? 'checked' : '' }}>
                                                            ...
                                                            <div class="module-item mb-3">
                                                                <div class="form-check">
                                                                    <input class="form-check-input module-checkbox"
                                                                           ...
                                                                           {{ in_array('Organization Reports', $adminModules ?? []) ? 'checked' : '' }}>
                                                            ...
                                                            <div class="module-item mb-3">
                                                                <div class="form-check">
                                                                    <input class="form-check-input module-checkbox"
                                                                           ...
                                                                           name="modules[]"
                                                                           value="Policy"
                                                                           {{ in_array('Policy', $adminModules ?? []) ? 'checked' : '' }}>
                                                        ...
                                                        <div class="category-body p-3">
                                                            <div class="form-check">
                                                                <input class="form-check-input module-checkbox"
                                                                       ...
                                                                       name="modules[]"
                                                                       value="Goals"
                                                                       {{ in_array('Goals', $adminModules ?? []) ? 'checked' : '' }}>
                                                        ...
                                                        <div class="category-body p-3">
                                                            <div class="form-check">
                                                                <input class="form-check-input module-checkbox"
                                                                       ...
                                                                       name="modules[]"
                                                                       value="Assets"
                                                                       {{ in_array('Assets', $adminModules ?? []) ? 'checked' : '' }}>
                                                        ...
                                                        <div class="category-body p-3">
                                                            <div class="form-check">
                                                                <input class="form-check-input module-checkbox"
                                                                       ...
                                                                       name="modules[]"
                                                                       value="Training"
                                                                       {{ in_array('Training', $adminModules ?? []) ? 'checked' : '' }}>
                                                        ...
                                                        <div class="category-body p-3">
                                                            <div class="form-check">
                                                                <input class="form-check-input module-checkbox"
                                                                       ...
                                                                       name="modules[]"
                                                                       value="Travel"
                                                                       {{ in_array('Travel', $adminModules ?? []) ? 'checked' : '' }}>
                                                        ...
                                                        <div class="category-body p-3">
                                                            <div class="form-check">
                                                                <input class="form-check-input module-checkbox"
                                                                       ...
                                                                       name="modules[]"
                                                                       value="Offboarding"
                                                                       {{ in_array('Offboarding', $adminModules ?? []) ? 'checked' : '' }}>
                                ...
                                <div class="col-md-12 mt-4">
                                    <button id="updateAdminBtn" class="btn btn-primary btn-lg" type="submit">
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    function validateField(field) {
        ...
        if (field.id === 'password' && field.value.trim() && field.value.trim().length < 6) {
            field.classList.add('is-invalid');
    ...
    // Initialize module counters and trigger hierarchy change on load
    updateModuleCounters();
    
    // Trigger hierarchy change to show existing modules properly
    if ($('#hierarchy').val()) {
