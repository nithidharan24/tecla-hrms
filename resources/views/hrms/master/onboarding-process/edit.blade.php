...
<div class="container mx-auto p-6">
    <h1 class="text-2xl font-bold mb-6">Edit Onboarding Record</h1>
    ...
    <form id="onboardingForm" action="{{ route('onboarding.update', $onboarding->id) }}" method="POST" enctype="multipart/form-data" class="bg-white shadow-md rounded-lg p-8 flex flex-col md:flex-row gap-8">
        @csrf
        @method('PUT')
        ...
        <div class="w-full md:w-3/4">
            ...
            <div id="step-1" class="tab-content active">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="full_name" id="full_name" value="{{ old('full_name', $onboarding->full_name) }}">
                    </div>
                    <div>
                        <label for="date_of_birth">Date of Birth <span class="text-red-500">*</span></label>
                        <input type="date" name="date_of_birth" id="date_of_birth" value="{{ old('date_of_birth', $onboarding->date_of_birth ? $onboarding->date_of_birth->format('Y-m-d') : '') }}">
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input type="text" name="blood_group" id="blood_group" value="{{ old('blood_group', $onboarding->blood_group) }}">
                    </div>
                    <div>
                        <label for="nationality">Nationality</label>
                        <input type="text" name="nationality" id="nationality" value="{{ old('nationality', $onboarding->nationality) }}">
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input type="text" name="mobile_number" id="mobile_number" value="{{ old('mobile_number', $onboarding->mobile_number) }}">
                    </div>
                    <div>
                        <label for="alternate_contact_number">Alternate Contact Number</label>
                        <input type="text" name="alternate_contact_number" id="alternate_contact_number" value="{{ old('alternate_contact_number', $onboarding->alternate_contact_number) }}">
                    </div>
                    <div>
                        <label for="personal_email_id">Personal Email ID <span class="text-red-500">*</span></label>
                        <input type="email" name="personal_email_id" id="personal_email_id" value="{{ old('personal_email_id', $onboarding->personal_email_id) }}">
                    </div>
                    <div>
                        <label for="aadhaar_number">Aadhaar Number</label>
                        <input type="text" name="aadhaar_number" id="aadhaar_number" value="{{ old('aadhaar_number', $onboarding->aadhaar_number) }}">
                    </div>
                    <div>
                        <label for="pan_number">PAN Number</label>
                        <input type="text" name="pan_number" id="pan_number" value="{{ old('pan_number', $onboarding->pan_number) }}">
                    </div>
                    <div>
                        <label for="passport_number">Passport Number (if applicable)</label>
                        <input type="text" name="passport_number" id="passport_number" value="{{ old('passport_number', $onboarding->passport_number) }}">
                    </div>
                    <div>
                        <label for="father_mother_name">Father's / Mother's Name</label>
                        <input type="text" name="father_mother_name" id="father_mother_name" value="{{ old('father_mother_name', $onboarding->father_mother_name) }}">
                    </div>
                    <div>
                        <label for="emergency_contact_name">Emergency Contact Name <span class="text-red-500">*</span></label>
                        <input type="text" name="emergency_contact_name" id="emergency_contact_name" value="{{ old('emergency_contact_name', $onboarding->emergency_contact_name) }}">
                    </div>
                    <div>
                        <label for="emergency_contact_number">Emergency Contact Number <span class="text-red-500">*</span></label>
                        <input type="text" name="emergency_contact_number" id="emergency_contact_number" value="{{ old('emergency_contact_number', $onboarding->emergency_contact_number) }}">
                    </div>
                    <div>
                        <label for="emergency_contact_relationship">Relationship with Emergency Contact</label>
                        <input type="text" name="emergency_contact_relationship" id="emergency_contact_relationship" value="{{ old('emergency_contact_relationship', $onboarding->emergency_contact_relationship) }}">
                    </div>
                </div>
            </div>
            ...
            <div id="step-2" class="tab-content hidden">
                ...
                <div class="grid grid-cols-1 gap-6">
                    <div>
                        ...
                        <textarea name="current_address" id="current_address" rows="3">{{ old('current_address', $onboarding->current_address) }}</textarea>
                    </div>
                    <div>
                        <label for="permanent_address">Permanent Address <span class="text-red-500">*</span></label>
                        <textarea name="permanent_address" id="permanent_address" rows="3">{{ old('permanent_address', $onboarding->permanent_address) }}</textarea>
                    </div>
                    <div class="flex items-center">
                        <input type="checkbox" name="is_current_permanent" id="is_current_permanent" value="1" {{ old('is_current_permanent', $onboarding->is_current_permanent) ? 'checked' : '' }} class="h-4 w-4 text-blue-600 border-gray-300 rounded">
            ...
            <div id="step-3" class="tab-content hidden">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="highest_qualification" id="highest_qualification" value="{{ old('highest_qualification', $onboarding->highest_qualification) }}">
                    </div>
                    <div>
                        <label for="stream_specialization">Stream / Specialization</label>
                        <input type="text" name="stream_specialization" id="stream_specialization" value="{{ old('stream_specialization', $onboarding->stream_specialization) }}">
                    </div>
                    <div>
                        <label for="institution_name">Institution Name</label>
                        <input type="text" name="institution_name" id="institution_name" value="{{ old('institution_name', $onboarding->institution_name) }}">
                    </div>
                    <div>
                        <label for="year_of_passing">Year of Passing</label>
                        <input type="number" name="year_of_passing" id="year_of_passing" value="{{ old('year_of_passing', $onboarding->year_of_passing) }}">
                    </div>
                    <div>
                        <label for="cgpa_percentage">CGPA / Percentage</label>
                        <input type="text" name="cgpa_percentage" id="cgpa_percentage" value="{{ old('cgpa_percentage', $onboarding->cgpa_percentage) }}">
                    </div>
                    <div>
                        <label for="tenth_twelfth_marks_boards_year">10th & 12th Marks / Boards / Year</label>
                        <input type="text" name="tenth_twelfth_marks_boards_year" id="tenth_twelfth_marks_boards_year" value="{{ old('tenth_twelfth_marks_boards_year', $onboarding->tenth_twelfth_marks_boards_year) }}">
                    </div>
                    <div class="md:col-span-2">
                        <label for="certifications">Certifications (if any)</label>
                        <textarea name="certifications" id="certifications" rows="3">{{ old('certifications', $onboarding->certifications) }}</textarea>
                    </div>
                </div>
            </div>
            ...
            <div id="step-4" class="tab-content hidden">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="previous_company_name" id="previous_company_name" value="{{ old('previous_company_name', $onboarding->previous_company_name) }}">
                    </div>
                    <div>
                        <label for="last_drawn_salary">Last Drawn Salary</label>
                        <input type="number" name="last_drawn_salary" id="last_drawn_salary" value="{{ old('last_drawn_salary', $onboarding->last_drawn_salary) }}">
                    </div>
                    <div class="md:col-span-2">
                        <label for="reason_for_leaving">Reason for Leaving</label>
                        <textarea name="reason_for_leaving" id="reason_for_leaving" rows="3">{{ old('reason_for_leaving', $onboarding->reason_for_leaving) }}</textarea>
                    </div>
                    <div>
                        ...
                        @if($onboarding->experience_letter_path)
                            <p class="text-xs text-gray-500 mt-1">Current: <a href="{{ asset($onboarding->experience_letter_path) }}" target="_blank" class="text-blue-500 hover:underline">View File</a></p>
                        @endif
                    </div>
                    <div>
                        ...
                        @if($onboarding->relieving_letter_path)
                            <p class="text-xs text-gray-500 mt-1">Current: <a href="{{ asset($onboarding->relieving_letter_path) }}" target="_blank" class="text-blue-500 hover:underline">View File</a></p>
                        @endif
                    </div>
                </div>
            </div>
            ...
            <div id="step-5" class="tab-content hidden">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="date" name="date_of_joining" id="date_of_joining" value="{{ old('date_of_joining', $onboarding->date_of_joining ? $onboarding->date_of_joining->format('Y-m-d') : '') }}">
                    </div>
                    <div>
                        <label for="employee_code">Employee Code</label>
                        <input type="text" name="employee_code" id="employee_code" value="{{ old('employee_code', $onboarding->employee_code) }}">
                    </div>
                    <div>
                        <label for="department">Department</label>
                        <input type="text" name="department" id="department" value="{{ old('department', $onboarding->department) }}">
                    </div>
                    <div>
                        <label for="designation">Designation</label>
                        <input type="text" name="designation" id="designation" value="{{ old('designation', $onboarding->designation) }}">
                    </div>
                    <div>
                        <label for="reporting_manager">Reporting Manager</label>
                        <input type="text" name="reporting_manager" id="reporting_manager" value="{{ old('reporting_manager', $onboarding->reporting_manager) }}">
                    </div>
                    <div>
                        <label for="work_location">Work Location</label>
                        <input type="text" name="work_location" id="work_location" value="{{ old('work_location', $onboarding->work_location) }}">
                    </div>
                    <div>
                        <label for="shift_timing">Shift Timing</label>
                        <input type="text" name="shift_timing" id="shift_timing" value="{{ old('shift_timing', $onboarding->shift_timing) }}">
                    </div>
                    <div>
                        <label for="employment_type">Type of Employment</label>
                        <select name="employment_type" id="employment_type">
                            <option value="">Select Type</option>
                            <option value="Full-time" {{ old('employment_type', $onboarding->employment_type) == 'Full-time' ? 'selected' : '' }}>Full-time</option>
                    ...
                    <div>
                        ...
                        <input type="number" name="probation_period_months" id="probation_period_months" value="{{ old('probation_period_months', $onboarding->probation_period_months) }}">
                    </div>
                </div>
            </div>
            ...
            <div id="step-6" class="tab-content hidden">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="bank_name" id="bank_name" value="{{ old('bank_name', $onboarding->bank_name) }}">
                    </div>
                    <div>
                        <label for="branch">Branch</label>
                        <input type="text" name="branch" id="branch" value="{{ old('branch', $onboarding->branch) }}">
                    </div>
                    <div>
                        <label for="account_holder_name">Account Holder Name</label>
                        <input type="text" name="account_holder_name" id="account_holder_name" value="{{ old('account_holder_name', $onboarding->account_holder_name) }}">
                    </div>
                    <div>
                        <label for="account_number">Account Number</label>
                        <input type="text" name="account_number" id="account_number" value="{{ old('account_number', $onboarding->account_number) }}">
                    </div>
                    <div>
                        <label for="ifsc_code">IFSC Code</label>
                        <input type="text" name="ifsc_code" id="ifsc_code" value="{{ old('ifsc_code', $onboarding->ifsc_code) }}">
                    </div>
                    <div>
                        ...
                        @if($onboarding->cancelled_cheque_path)
                            <p class="text-xs text-gray-500 mt-1">Current: <a href="{{ asset($onboarding->cancelled_cheque_path) }}" target="_blank" class="text-blue-500 hover:underline">View File</a></p>
                        @endif
                    </div>
                </div>
            </div>
            ...
            <div id="step-7" class="tab-content hidden">
                ...
                <div class="grid grid-cols-1 gap-6">
                    <div class="flex items-center">
                        <input type="checkbox" name="has_medical_conditions" id="has_medical_conditions" value="1" {{ old('has_medical_conditions', $onboarding->has_medical_conditions) ? 'checked' : '' }} class="h-4 w-4 text-blue-600 border-gray-300 rounded">
                    ...
                    <div>
                        ...
                        <textarea name="medical_history" id="medical_history" rows="3">{{ old('medical_history', $onboarding->medical_history) }}</textarea>
                    </div>
                    <div class="flex items-center">
                        <input type="checkbox" name="is_covered_by_insurance" id="is_covered_by_insurance" value="1" {{ old('is_covered_by_insurance', $onboarding->is_covered_by_insurance) ? 'checked' : '' }} class="h-4 w-4 text-blue-600 border-gray-300 rounded">
                    ...
                    <div>
                        ...
                        <input type="text" name="nominee_name" id="nominee_name" value="{{ old('nominee_name', $onboarding->nominee_name) }}">
                    </div>
                    <div>
                        <label for="nominee_relationship">Nominee Relationship</label>
                        <input type="text" name="nominee_relationship" id="nominee_relationship" value="{{ old('nominee_relationship', $onboarding->nominee_relationship) }}">
                    </div>
                </div>
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        @if($onboarding->resume_path)
                            <p class="text-xs text-gray-500 mt-1">Current: <a href="{{ asset($onboarding->resume_path) }}" target="_blank" class="text-blue-500 hover:underline">View File</a></p>
                        @endif
                    </div>
                    <div>
                        ...
                        @if($onboarding->passport_photo_path)
                            <p class="text-xs text-gray-500 mt-1">Current: <a href="{{ asset($onboarding->passport_photo_path) }}" target="_blank" class="text-blue-500 hover:underline">View File</a></p>
                        @endif
                    </div>
                    <div>
                        ...
                        @if($onboarding->aadhaar_card_front_path)
                            <p class="text-xs text-gray-500 mt-1">Current: <a href="{{ asset($onboarding->aadhaar_card_front_path) }}" target="_blank" class="text-blue-500 hover:underline">View File</a></p>
                        @endif
                    </div>
                    <div>
                        ...
                        @if($onboarding->aadhaar_card_back_path)
                            <p class="text-xs text-gray-500 mt-1">Current: <a href="{{ asset($onboarding->aadhaar_card_back_path) }}" target="_blank" class="text-blue-500 hover:underline">View File</a></p>
                        @endif
                    </div>
                    <div>
                        ...
                        @if($onboarding->pan_card_path)
                            <p class="text-xs text-gray-500 mt-1">Current: <a href="{{ asset($onboarding->pan_card_path) }}" target="_blank" class="text-blue-500 hover:underline">View File</a></p>
                        @endif
                    </div>
                    <div>
                        ...
                        @if($onboarding->educational_certificates_path)
                            <p class="text-xs text-gray-500 mt-1">Current: <a href="{{ asset($onboarding->educational_certificates_path) }}" target="_blank" class="text-blue-500 hover:underline">View File</a></p>
                        @endif
                    </div>
                    <div>
                        ...
                        @if($onboarding->experience_certificates_path)
                            <p class="text-xs text-gray-500 mt-1">Current: <a href="{{ asset($onboarding->experience_certificates_path) }}" target="_blank" class="text-blue-500 hover:underline">View File</a></p>
                        @endif
                    </div>
                    <div>
                        ...
                        @if($onboarding->address_proof_path)
                            <p class="text-xs text-gray-500 mt-1">Current: <a href="{{ asset($onboarding->address_proof_path) }}" target="_blank" class="text-blue-500 hover:underline">View File</a></p>
                        @endif
                    </div>
                    <div>
                        ...
                        @if($onboarding->signed_offer_letter_path)
                            <p class="text-xs text-gray-500 mt-1">Current: <a href="{{ asset($onboarding->signed_offer_letter_path) }}" target="_blank" class="text-blue-500 hover:underline">View File</a></p>
                        @endif
                    </div>
                    <div>
                        ...
                        @if($onboarding->covid_vaccination_certificate_path)
                            <p class="text-xs text-gray-500 mt-1">Current: <a href="{{ asset($onboarding->covid_vaccination_certificate_path) }}" target="_blank" class="text-blue-500 hover:underline">View File</a></p>
                        @endif
                    </div>
                </div>
            </div>
            ...
            <div id="step-9" class="tab-content hidden">
                ...
                <div class="grid grid-cols-1 gap-6">
                    <div class="flex items-start">
                        <input type="checkbox" name="declaration_agreed" id="declaration_agreed" value="1" {{ old('declaration_agreed', $onboarding->declaration_agreed) ? 'checked' : '' }} class="mt-1 h-4 w-4 text-blue-600 border-gray-300 rounded">
                    ...
                    <div>
                        ...
                        <input type="text" name="declaration_place" id="declaration_place" value="{{ old('declaration_place', $onboarding->declaration_place) }}">
                    </div>
                    <div>
                        <label for="declaration_date">Date</label>
                        <input type="date" name="declaration_date" id="declaration_date" value="{{ old('declaration_date', $onboarding->declaration_date ? $onboarding->declaration_date->format('Y-m-d') : '') }}">
                    </div>
                    <div>
                        ...
                        @if($onboarding->signature_path)
                            <p class="text-xs text-gray-500 mt-1">Current: <a href="{{ asset($onboarding->signature_path) }}" target="_blank" class="text-blue-500 hover:underline">View File</a></p>
                        @endif
                    </div>
                </div>
            </div>
            ...
            <div class="flex justify-content-end mt-4 mb-2">
                <button type="submit" class="btn bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">Update Record</button>
            </div>
        </div>
    </form>
</div>
    ...
    $(document).ready(function() {
        ...
        $('#onboardingForm').on('submit', function(e) {
            ...
            if (!$('#declaration_agreed').is(':checked')) {
                isValid = false;
                // Optionally, highlight the checkbox or show an an alert
            }
