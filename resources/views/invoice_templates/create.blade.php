...
<div class="content container-fluid">
    <div class="page-header">
        <div class="row align-items-center">
            <div class="col">
                <h3 class="page-title">Add Invoice Template</h3>
                <ul class="breadcrumb">
                    ...
                    <form action="{{ route('invoice-template.store') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <small class="form-text text-muted">
                                ...
                                <code>@{{ $invoice->invoice_date }}</code>,
                                <code>@{{ $customer->name }}</code>,
                                <code>@{{ $customer->address }}</code>,
                                <code>@{{ $items }}</code>,
                                <code>@{{ $grandTotal }}</code>,
                                <code>@{{ $companyName }}</code>,
                                <code>@{{ $logoDataUri }}</code>,
                                <code>@{{ $offerSignatureDataUri }}</code>,
                                <code>@{{ $gst }}</code>,
                                <code>@{{ $bankName }}</code>, etc.
                            </small>
                        </div>
...
<head>
    ...
    <style>
        ...
        .totals-table .total-row-border { border-top: 2px solid #000; border-bottom: 2px solid #000; }
