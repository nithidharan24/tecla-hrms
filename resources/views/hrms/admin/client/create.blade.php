...
<div class="container">
    <div class="card">
        ...
        <div class="card-body">
            <form id="add_client" method="POST" action="{{route('client.store')}}" enctype="multipart/form-data" class="needs-validation" novalidate>
                @csrf
                <div class="row">
                    <div class="col-md-6">
                        <div class="input-block mb-3">
                            <label for="first_name" class="col-form-label">First Name <span class="text-danger">*</span></label>
                            <input id="first_name" name="first_name" class="form-control" type="text" value="{{ old('first_name') }}" required />
                            <div class="invalid-feedback">Please enter first name.</div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="input-block mb-3">
                            <label for="last_name" class="col-form-label">Business Name <span class="text-danger">*</span></label>
                            <input id="last_name" name="last_name" class="form-control" type="text" value="{{ old('last_name') }}" required />
                    ...
                    <div class="col-md-6">
                        <div class="input-block mb-3">
                            ...
                            <input id="company_name" name="company_name" class="form-control" type="text" value="{{ old('company_name') }}" required />
                    ...
                    <div class="col-md-6">
                        <div class="input-block mb-3">
                            ...
                            <input id="website_url" name="website_url" class="form-control" type="url" value="{{ old('website_url') }}" placeholder="https://example.com" />
                    ...
                    <div class="col-md-6">
                        <div class="input-block mb-3">
                            ...
                            <input id="live_url" name="live_url" class="form-control" type="url" value="{{ old('live_url') }}" placeholder="https://example.com" />
                            <div class="invalid-feedback">Please enter a valid URL.</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="input-block mb-3">
                            ...
                            <textarea name="client_address" id="address" class="form-control" style="resize: none;" rows="4" required>{{ old('client_address') }}</textarea>
                            <div class="invalid-feedback">Please enter address.</div>
                        </div>
                    </div>
                </div>

                <!-- New Section: Hosting Information -->
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="input-block mb-3">
                            ...
                            <select name="hosting_type" id="hosting_type" class="form-control" required>
                                ...
                                <option value="hosting_with_us" {{ old('hosting_type') == 'hosting_with_us' ? 'selected' : '' }}>Hosting with us</option>
                                <option value="their_hosting" {{ old('hosting_type') == 'their_hosting' ? 'selected' : '' }}>Their Hosting</option>
                                <option value="hosting_maintenance_with_us" {{ old('hosting_type') == 'hosting_maintenance_with_us' ? 'selected' : '' }}>Hosting & Maintenance with us</option>
                            </select>
                    ...
                    <div class="col-md-4">
                        <div class="input-block mb-3">
                            ...
                            <select name="hosting_status" id="hosting_status" class="form-control" required>
                                ...
                                <option value="active" {{ old('hosting_status') == 'active' ? 'selected' : '' }}>Active</option>
                                <option value="inactive" {{ old('hosting_status') == 'inactive' ? 'selected' : '' }}>Inactive</option>
                                <option value="expired" {{ old('hosting_status') == 'expired' ? 'selected' : '' }}>Expired</option>
                            </select>
                    ...
                    <div class="col-md-4">
                        <div class="input-block mb-3">
                            ...
                            <input id="hosting_expiry_date" name="hosting_expiry_date" class="form-control" type="date" value="{{ old('hosting_expiry_date') }}" />
                        </div>
                    </div>
                </div>

                <!-- New Section: Domain Information -->
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="input-block mb-3">
                            ...
                            <select name="domain_type" id="domain_type" class="form-control" required>
                                <option value="">Select Type</option>
                                <option value="domain_with_us" {{ old('domain_type') == 'domain_with_us' ? 'selected' : '' }}>Domain with us</option>
                                <option value="their_domain" {{ old('domain_type') == 'their_domain' ? 'selected' : '' }}>Their Domain</option>
                                <option value="domain_maintenance_with_us" {{ old('domain_type') == 'domain_maintenance_with_us' ? 'selected' : '' }}>Domain & Maintenance with us</option>
                            </select>
                    ...
                    <div class="col-md-4">
                        <div class="input-block mb-3">
                            ...
                            <select name="domain_status" id="domain_status" class="form-control" required>
                                <option value="">Select Status</option>
                                <option value="active" {{ old('domain_status') == 'active' ? 'selected' : '' }}>Active</option>
                                <option value="inactive" {{ old('domain_status') == 'inactive' ? 'selected' : '' }}>Inactive</option>
                                <option value="expired" {{ old('domain_status') == 'expired' ? 'selected' : '' }}>Expired</option>
                            </select>
                    ...
                    <div class="col-md-4">
                        <div class="input-block mb-3">
                            ...
                            <input id="domain_expiry_date" name="domain_expiry_date" class="form-control" type="date" value="{{ old('domain_expiry_date') }}" />
                        </div>
                    </div>
                </div>

                <!-- New Section: Digital Marketing Information -->
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="input-block mb-3">
                            ...
                            <input id="digital_marketing_start_date" name="digital_marketing_start_date" class="form-control" type="date" value="{{ old('digital_marketing_start_date') }}" />
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="input-block mb-3">
                            <label for="digital_marketing_end_date" class="col-form-label">Service End Date</label>
                            <input id="digital_marketing_end_date" name="digital_marketing_end_date" class="form-control" type="date" value="{{ old('digital_marketing_end_date') }}" />
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="input-block mb-3">
                            ...
                            <input id="hosting_amc_renewal_date" name="hosting_amc_renewal_date" class="form-control" type="date" value="{{ old('hosting_amc_renewal_date') }}" />
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="input-block mb-3">
                            <label for="amc_reminder_days" class="col-form-label">AMC Reminder Days</label>
                            <input id="amc_reminder_days" name="amc_reminder_days" class="form-control" type="number" min="1" max="365" value="{{ old('amc_reminder_days', 30) }}" placeholder="Days before expiry to send reminder" />
                ...
                <div class="submit-section">
                    <button type="submit" id="submitbtn" class="btn btn-primary submit-btn">Create Client</button>
    ...
    $(document).ready(function () {
        ...
        $("#add_client").validate({
            ...
            submitHandler: function (form) {
                // Show loading state
                $('#submitbtn').prop('disabled', true).html('<i class="fa fa-spinner fa-spin"></i> Creating Client...');
                form.submit();
            }
        });
