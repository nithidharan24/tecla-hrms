...
@section('content')
        ...
        <div class="row">
            <div class="col-md-12">
                <ul class="custom-report-tabs" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="all-assets-tab" data-bs-toggle="tab"
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="tab-content">
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="summary-card card-primary">
                                    ...
                                    <div class="summary-content">
                                        <h6>Total Assets</h6>
                                        <h2>{{ $assets->total() ?? 0 }}</h2>
                                        <p class="mb-0"><i class="fa fa-arrow-up"></i> All registered assets</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-md-6">
                                <div class="summary-card card-info">
                                    ...
                                    <div class="summary-content">
                                        ...
                                        <p class="mb-0"><i class="fa fa-users"></i> Currently with employees</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-md-6">
                                <div class="summary-card card-success">
                                    ...
                                    <div class="summary-content">
                                        <h6>Available</h6>
                                        <h2>{{ $availableCount ?? 0 }}</h2>
                                        <p class="mb-0"><i class="fa fa-warehouse"></i> Ready to assign</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-md-6">
                                <div class="summary-card card-warning">
                                    ...
                                    <div class="summary-content">
                                        <h6>Returned</h6>
                                        <h2>{{ $returnedCount ?? 0 }}</h2>
                                        <p class="mb-0"><i class="fa fa-history"></i> Returned to inventory</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="card chart-card">
                                    <div class="card-header bg-transparent border-0">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <h5 class="mb-0">Department-wise Assets</h5>
                                                <small class="text-muted">Top 5 departments with assigned assets</small>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <canvas id="departmentChart" height="280"></canvas>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="card chart-card">
                                    <div class="card-header bg-transparent border-0">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <h5 class="mb-0">Employee-wise Assets</h5>
                                                <small class="text-muted">Top 5 employees with assigned assets</small>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                ...
                                <div class="card chart-card">
                                    <div class="card-header bg-transparent border-0">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <h5 class="mb-0">Asset Status Overview</h5>
                                                <small class="text-muted">Complete breakdown of asset distribution</small>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card-body">
                    ...
                    {{-- All Assets Tab --}}
                    <div class="tab-pane fade" id="all-assets" role="tabpanel">
                        @if($assets->count() > 0)
                            <div class="card">
                                <div class="card-body">
    ...
    <style>
        ...
        .summary-card.card-primary { background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); }
        .summary-card.card-primary::before { background: #fff; }
        .summary-card.card-info { background: linear-gradient(135deg, #36d1dc 0%, #5b86e5 100%); }
        .summary-card.card-info::before { background: #fff; }
        .summary-card.card-success { background: linear-gradient(135deg, #11998e 0%, #38ef7d 100%); }
        .summary-card.card-success::before { background: #fff; }
        .summary-card.card-warning { background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%); }
        .summary-card.card-warning::before { background: #fff; }
    ...
    <script>
        ...
        function initializeCharts() {
            @php
                $departmentData = collect($assignments)->where('status', 'assigned')
                    ->groupBy('department')
                    ->map(fn($items) => $items->count())
                    ->sortDesc()
                    ->take(5);
                
                $employeeData = collect($assignments)->where('status', 'assigned')
                    ->groupBy(fn($item) => $item->firstname . ' ' . $item->lastname)
                    ->map(fn($items) => $items->count())
                    ->sortDesc()
                    ->take(5);
            @endphp
            ...
            if (empCtx) {
                new Chart(empCtx, {
                    type: 'doughnut',
                    data: {
                        labels: {!! json_encode($employeeData->keys()) !!},
                        datasets: [{
                            data: {!! json_encode($employeeData->values()) !!},
                            backgroundColor: [
                                'rgba(255, 99, 132, 0.6)',
                                'rgba(54, 162, 235, 0.6)',
                                'rgba(255, 206, 86, 0.6)',
            ...
            if (statusCtx) {
                new Chart(statusCtx, {
                    type: 'bar',
                    data: {
                        labels: ['Total Assets', 'Assigned', 'Available', 'Returned'],
                        datasets: [{
                            label: 'Count',
                            data: [
                                {{ $assets->total() ?? 0 }},
