...
.timesheet-icon {
    background: linear-gradient(135deg, #fa8128 0%, #fbbf24 100%);
}
...
<div class="content container-fluid report-page">
    ...
    <!-- ======================================
         MY REPORTS TAB (EMPLOYEE VIEW)
         Employees see only their own timesheet data
    ======================================= -->
    @if(in_array('My Reports', $modules))
    <div id="my-reports" class="tab-content active">
        <div class="report-card">
            ...
            <div class="report-grid">
                ...
                <!-- Time Tracker (Includes Timesheet Report) -->
                <div class="report-section-group">
                    <div class="report-section-title">
                    ...
                    <!-- TIMESHEET EMPLOYEE REPORT - EMPLOYEE VIEW -->
                    <div class="report-item timesheet-highlight">
                        <div class="item-icon" style="background: #fa8128; color: white;">
                            <i class="fas fa-file-alt"></i>
                        </div>
                        <a href="{{ route('timesheet-employee-reports.index') }}">
                            <strong>My Timesheet Report</strong>
                            <small style="margin-left: auto; color: #6b7280;">(Self)</small>
                        </a>
                    </div>
                </div>
    ...
    <!-- ======================================
         TEAM REPORTS TAB (MANAGER/TEAM LEAD VIEW)
         Managers see their team members' timesheet data
    ======================================= -->
    @if(in_array('Team Reports', $modules))
    <div id="team-reports" class="tab-content">
        <div class="report-card">
            ...
            <div class="report-grid">
                ...
                <!-- Time Tracker (Includes Team Timesheet Report) -->
                <div class="report-section-group">
                    <div class="report-section-title">
                    ...
                    <!-- TEAM TIMESHEET REPORT - MANAGER VIEW -->
                    <div class="report-item timesheet-highlight">
                        <div class="item-icon" style="background: #4facfe; color: white;">
                            <i class="fas fa-users"></i>
                        </div>
                        <a href="{{ route('timesheet-employee-reports.index') }}">
                            <strong>Team Timesheet Report</strong>
                            <small style="margin-left: auto; color: #6b7280;">(Team View)</small>
                        </a>
                    </div>
                </div>
                ...
                <div class="report-section-group">
                    ...
                    <div class="report-item">
                        ...
                        <a href="#">Productivity Analysis</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- ======================================
         ORGANIZATION REPORTS TAB (ADMIN VIEW)
         Admins see all employees' timesheet data
    ======================================= -->
    @if(in_array('Organization Reports', $modules))
    <div id="org-reports" class="tab-content">
        <div class="report-card">
            ...
            <div class="report-grid">
                ...
                <!-- 2. PROJECT & TASK REPORTS (Includes Timesheet Reports) -->
                <div class="report-section-group">
                    <div class="report-section-title">
                    ...
                    <!-- EMPLOYEE TIMESHEET REPORT - ADMIN VIEW (ALL EMPLOYEES) -->
                    <div class="report-item timesheet-highlight">
                        <div class="item-icon" style="background: #fa8128; color: white;">
                            <i class="fas fa-file-alt"></i>
                        </div>
                        <a href="{{ route('timesheet-employee-reports.index') }}">
                            <strong>Employee Timesheet Report</strong>
                            <small style="margin-left: auto; color: #6b7280;">(All Employees)</small>
                        </a>
                    </div>
                    ...
                    <div class="report-item">
                        ...
                        <a href="#">Weekly Timesheet Summary</a>
                    </div>
                ...
                <!-- 6. TIMESHEET ANALYTICS (New Section) -->
                <div class="report-section-group">
                    <div class="report-section-title">
                        <i class="fas fa-chart-pie timesheet-icon" style="background: transparent; color: #fa8128;"></i> Timesheet Analytics
                        <span class="report-count">3</span>
                    </div>
                    
                    <div class="report-item">
                        <div class="item-icon" style="background: #fa812820; color: #fa8128;">
                            <i class="fas fa-chart-bar"></i>
                        </div>
    ...
    <!-- If no modules are accessible -->
    @if(!in_array('My Reports', $modules) && !in_array('Team Reports', $modules) && !in_array('Organization Reports', $modules))
    <div class="report-card">
        <div class="report-empty-state">
            <i class="fas fa-chart-pie"></i>
            <h5>No Reports Available</h5>
            <p>You don't have access to any report modules. Please contact your administrator.</p>
        </div>
    </div>
    @endif
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Add hover effects for timesheet items
    const timesheetItems = document.querySelectorAll('.timesheet-highlight');
