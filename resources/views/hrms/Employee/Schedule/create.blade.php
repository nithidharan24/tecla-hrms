...
<div class="lv-wrap">
    <div class="lv-topbar">
        <div>
            <h1 class="lv-page-title">Add Schedule</h1>
            <ul class="breadcrumb">
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
            <div class="lv-panel">
                <div class="lv-panel-header">
                    <h4 class="lv-panel-title">Scheduling Details</h4>
                </div>
                <div class="card-body">
                    <form id="addSchedule" method="POST" action="{{ route('scheduling.store') }}">
                        ...
                        <div class="row mt-4 text-center">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                <button class="lv-btn lv-btn-primary" type="submit" id="submitBtn" disabled>Submit</button>
                                <a href="{{ route('scheduling.index') }}" class="lv-btn lv-btn-secondary ms-2">Cancel</a>
                                <div id="loadingSpinner" class="spinner-border text-primary d-none" role="status" style="vertical-align: middle; margin-left: 10px;">
