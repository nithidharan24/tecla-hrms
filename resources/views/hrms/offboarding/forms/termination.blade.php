<div class="card mb-4">
    <div class="card-header">
        <h6 class="mb-0">Termination Details</h6>
    </div>
    <div class="card-body">
        <div class="row mb-3">
            <div class="col-md-6">
        ...
        <div class="row mb-3">
            <div class="col-md-12">
                ...
                <textarea class="form-control" name="explanation" rows="3" data-required="true"></textarea>
            </div>
        </div>

        <input type="hidden" name="employee_status" value="Terminated">
        <input type="hidden" name="exit_type" value="Termination">
    </div>
</div>