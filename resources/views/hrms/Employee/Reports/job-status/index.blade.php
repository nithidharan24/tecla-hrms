...
<div class="report-container">
   ...
   <div class="controls">
    <div style="display: flex; align-items: flex-end; gap: 20px; flex-wrap: wrap;">
        ...
        <div style="display: flex; flex-direction: column;">
            <label style="font-size: 13px; font-weight: 600; color: #4b5563; margin-bottom: 4px;">Project</label>
        ...
        <button class="btn-small btn-primary" onclick="applyFilter()" style="height: 42px;">Filter</button>
    </div>
