...
<div class="employee-strip">
    <div class="info">
        ...
        @else
            ...
            <p>Please select an employee from the dropdown above to view leave balance details.</p>
        @endif
    </div>
...
<div>
   ...
   {{-- Summary Cards --}}
@if(isset($employee) && $employee && !empty($summary))
@php
...
@else
<div style="background: #fff; border-radius: 12px; padding: 60px 20px; text-align: center; border: 1px solid #eef2f7;">
    <i class="fa-regular fa-calendar-alt" style="font-size: 64px; color: #ff6b2c; opacity: 0.5;"></i>
    <h3 style="margin-top: 16px; color: #374151;">No Employee Selected</h3>
    <p style="color: #6b7280; margin-top: 8px;">Please select an employee from the dropdown above to view their leave balance details.</p>
</div>
@endif
