...
<div class="content container-fluid" style="padding-top: 20px;">
        ...
        <div class="row mt-4">
            <div class="col-xl-12">
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                        <form id="employeeForm" method="POST" action="{{ route('employee.store') }}" enctype="multipart/form-data" class="needs-validation" novalidate>
                            @csrf
                            <div class="row">
    ...
    @enderror
                              ...
                              <div class="col-md-6 mb-3">
                                    ...
                                    <input type="date" class="form-control" name="joiningdate" id="joining_date" value="{{ old('joiningdate') }}" required>
...
<!-- <CHANGE> Updated Reporting Manager and added Team Lead fields -->
<!-- Reporting Manager -->
<div class="col-md-6 mb-3">
...
<div class="col-md-6 mb-3">
    ...
    @enderror
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="file" class="form-control" name="profile_image" id="profile_image" accept=".jpg, .jpeg, .png" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" name="basic" id="basic" 
                                       placeholder="Enter basic salary" value="{{ old('basic') }}" step="0.01" min="0">
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" name="da" id="da" 
                                       value="" placeholder="DA percentage" step="0.01" min="0" max="100">
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" name="hra" id="hra" 
                                       value="" placeholder="HRA percentage" step="0.01" min="0" max="100">
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" name="conveyance" id="conveyance" 
                                       value="{{ old('conveyance', 0) }}" placeholder="Conveyance amount" step="0.01" min="0">
                            </div>

                            <div class="mb-3">
                                <label class="form-label">Special Allowance</label>
                                <input type="number" class="form-control" name="allowance" id="allowance" 
                                       value="{{ old('allowance', 0) }}" placeholder="Special allowance" step="0.01" min="0">
                            </div>

                            <div class="mb-3">
                                <label class="form-label">Medical Allowance</label>
                                <input type="number" class="form-control" name="medical" id="medical" 
                                       value="{{ old('medical', 0) }}" placeholder="Medical allowance" step="0.01" min="0">
                            </div>
                        </div>
           ...
           readonly>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" name="tds" id="tds" 
                                       value="{{ old('tds', 0) }}" placeholder="TDS amount" step="0.01" min="0">
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" name="tax" id="tax" 
                                       value="{{ old('tax', 0) }}" placeholder="Professional tax" step="0.01" min="0">
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" name="welfare" id="welfare" 
                                       value="{{ old('welfare', 0) }}" placeholder="Welfare fund" step="0.01" min="0">
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control bg-light" name="net_salary" id="net_salary" 
                                       readonly placeholder="Calculated net salary">
                            </div>
                        </div>
                    </div>
...
<!-- Personal Information Tab (Add Form) -->
<div class="tab-pane fade" id="personal" role="tabpanel" aria-labelledby="personal-tab">
    <div class="card shadow-sm mt-4">
        ...
        <div class="card-body">
             ...
             <!-- Emergency Contact Tab (Add Form) -->
        ...
        <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="primary_name" class="form-control" placeholder="Enter Primary Contact Name" required>
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="primary_phone" class="form-control" placeholder="Enter Phone Number" required>
                    </div>
        ...
        <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="bank_account_no" id="bank_account_no" class="form-control" placeholder="Enter Account Number" required>
                    </div>
                </div>
...
<!-- Updated Module Categories for Employee Create Form -->
...
<script>
    ...
    $(document).ready(function() {
        ...
        // Remove the default form validation that might block Playwright
        ...
        form.addEventListener('submit', function(event) {
            ...
            // Special check for training field
            ...
            if (!isValid) {
                ...
                saveBtn.innerHTML = '<i class="fas fa-save me-2"></i>Save Employee';
                return;
            }
        ...
        // Remove handlers for dynamic elements
    ...
    function initializeSalaryCalculations() {
        ...
        // Auto-calculate when salary fields change (with debounce)
    ...
    $(document).ready(function() {
        ...
        // Initialize event listeners for all salary fields
        initializeSalaryCalculations();
        
        // Calculate salary when button is clicked
        calculateBtn.on('click', calculateSalary);
        ...
        // If basic salary is already filled, calculate immediately
        const basicSalary = parseFloat($('#basic').val()) || 0;
        if (basicSalary > 0) {
